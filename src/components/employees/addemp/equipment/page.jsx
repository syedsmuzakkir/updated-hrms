  ...
  return (
    <div>
      ...
      >
        ...
        <div className="ml-80">
          ...
          <Button
            ...
            onClick={()=>{router.push('/employees/addemp/documents')}}
          >
            Next
          </Button>
        </div>
      ...
      <div
          ...
          >
             <div className=' flex gap-5'>
            <div className='bg-cyan-400 h-12 w-16 rounded-full'><img src='https://www.iconpacks.net/icons/1/free-keyboard-icon-1405-thumb.png' className='rounded-xl h-8 w-8 ml-2 mt-1.5'></img></div>
            <div className='w-full'><h1 className='text-xl'><b>Keyboard</b></h1>
            ...
            <p className='text-gray-400 mt-1.5'>Notes: Assign new keyboard</p></div>
            <div><Button type="primary" className='text-black rounded-none mt-3'>Edit</Button></div>
            </div>
          </div>
    </div>
  );
